...
from meraki_engine.primitive.vision import visual_locate, visual_click, capture_screenshot, VISION_CONFIDENCE_THRESHOLD
...
__all__ = [
    "CdpClient",
    "visual_locate", "visual_click", "capture_screenshot", "VISION_CONFIDENCE_THRESHOLD",
